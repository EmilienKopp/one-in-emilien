...
- This repository uses `sail` for local development. When suggesting Artisan commands for local development, you should prefix them with `./vendor/bin/sail`, e.g. `./vendor/bin/sail artisan migrate --force`.
