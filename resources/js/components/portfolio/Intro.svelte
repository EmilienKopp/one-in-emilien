...
<ContentSection title="Only one in a million" id="intro">
    <p
        class="sm:text-md mb-4 max-w-xl text-left text-sm font-extrabold"
        slot="pretext"
    >
        Hi! I'm Emilien, a senior full-stack developer and software architect
        based near Tokyo. I'm a creative problem solver who builds well
        architected systems and open-source solutions.
    </p>
    <svg
        id="eyebrow"
        slot="eyebrow"
    ...
    <div slot="lead">
        <dl
            class="text-md grid max-w-xl grid-cols-5 text-left font-extrabold sm:text-2xl"
        >
            <div class="col-span-5 my-2">Here's me, in short:</div>
            <dt>✅</dt>
            <dd>designs systems from domain model to deployment</dd>
            <dt>✅</dt>
            <dd>keeps all stakeholders and teammates aligned</dd>
            <dt>✅</dt>
            <dd>can lead a team...</dd>
            <dt>✅</dt>
            <dd>...and teach architecture best practices</dd>
            <dt>✅</dt>
            <dd>all that in English, French, and Japanese</dd>
            <div class="col-span-5 my-2">
                This is the web architect you're looking for. 🤖
            </div>
        </dl>
    </div>
