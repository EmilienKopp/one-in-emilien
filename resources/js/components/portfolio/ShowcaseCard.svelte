...
<div class="group hover:!text-default aspect-video">
    <figure class="relative mb-1 h-full w-full overflow-hidden">
        <Picture
        ...
        <figcaption class="absolute inset-0">
            ...
            >
                <h3
                    class="pointer-events-none cursor-default text-center text-xl font-extrabold uppercase"
                >
                    {site.title}
                </h3>
